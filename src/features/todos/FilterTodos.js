const FilterTodos = ({ onFilter, filter }) => {
    ...
    return (
        <div className="row d-flex">
            ...
            <div className="col-sm-4">
                <button disabled={filter === 'TODO'} onClick={onFilter.bind(null, 'TODO')}
                    className={btnClassTodo}>TO DO</button>
            </div>

            <div className="col-sm-4">
                <button disabled={filter === 'COMPLETED'} onClick={onFilter.bind(null, 'COMPLETED')}
